...
beautiful.init(awful.util.getdir("config") .. "/themes/deviant/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "p",      function () awful.spawn("pyroom") end,                         {description = "pyroom editor", group = "launcher"}),
    awful.key({ modkey }, "w",      function () awful.spawn("obsidian") end,                       {description = "obsidian vaults", group = "launcher"}),
    ...
    awful.key({ modkey }, "i",      function () awful.spawn(editor)  end, {description = "emacs", group = "launcher"}),
    ...
    awful.key({ modkey }, "v", function () awful.spawn(gui_editor)  end, {description = "vscode", group = "launcher"}),

    --
    -- Screenshot
    awful.key({ },           "Print", function () awful.spawn("sshot selection") end, {description = "capture selection", group = "screenshot"}),
    awful.key({ "Shift" },   "Print", function () awful.spawn("sshot fulldesk")  end, {description = "capture entire desktop", group = "screenshot"}),
    awful.key({ "Control" }, "Print", function () awful.spawn("sshot focused")  end,  {description = "capture window in focus", group = "screenshot"}),

    --
    -- Sound
    awful.key({ modkey }, "=",          function () awful.spawn("soundsh up") end,   {description = "increase volume by 5%", group = "sound"}),
    awful.key({ modkey }, "-",          function () awful.spawn("soundsh down") end, {description = "decrease volume by 5%", group = "sound"}),
    awful.key({ modkey, "Shift" }, "=", function () awful.spawn("soundsh show") end, {description = "display current volume", group = "sound"})
)
