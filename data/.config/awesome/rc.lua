...
globalkeys = gears.table.join(
    ...
    awful.key({                   }, "Print", function () awful.spawn("scrot -s ~/media/images/screenshots/%Y%m%d_%H%I%M.png")   end,
    ...
    awful.key({"Shift"            }, "Print", function () awful.spawn("scrot ~/media/images/screenshots/%Y%m%d_%H%I%M.png")   end,
              {description = "capture a screenshot of selection", group = "screenshot"}),
